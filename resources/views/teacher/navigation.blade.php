...
<body>
	...
	<div class="sidebar">
		...
		<ul class="nav-links">
			...
			<li class="nav-links-li {{ (request()->is('teacher/attendance*')) ? 'active' : '' }}">
    <div class="iocn-link">
        <a href="{{ route('teacher.daily_attendance') }}">
            <div class="sidebar_icon left-icon">
			...
			<li class="nav-links-li {{ (request()->is('teacher/gradebook')) ? 'active' : '' }}">
    <div class="iocn-link">
        <a href="{{ route('teacher.gradebook') }}">
          ...
          <li class="nav-links-li {{ request()->is('hr/leave_list*') || request()->is('attendence/list*') || request()->is('payment/list*') ? 'showMenu':'' }}">
	        ...
	        <li class="nav-links-li {{ (request()->is('teacher/noticeboard*')) ? 'active' : '' }}">
    <div class="iocn-link">
        <a href="{{ route('teacher.noticeboard.list') }}">
            <div class="sidebar_icon left-icon ">
...
<li class="nav-links-li {{ (request()->is('teacher/events/list*')) ? 'active' : '' }}">
    <div class="iocn-link">
        <a href="{{ route('teacher.events.list') }}">
            <div class="sidebar_icon left-icon">
