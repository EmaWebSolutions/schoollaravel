...
<body>
	...
	<div class="sidebar">
      ...
      <li class="av-links-li {{ (request()->is('student/attendance*')) ? 'active' : '' }}">
         <div class="iocn-link">
        <a  href="{{ route('student.daily_attendance') }}">
       <div class="sidebar_icon left-icon">
      ...
      <li class="nav-links-li {{ request()->is('student/fee_manager*')  ? 'showMenu':'' }}">
          <div class="iocn-link">
			...
			<li class="nav-links-li {{ request()->is('student/book*') || request()->is('student/book_issue*')  ? 'showMenu':'' }}">
				<div class="iocn-link">
			    <a href="#">
                     <div class="sidebar_icon left-icon">
      ...
      <li class="nav-links-li {{ (request()->is('student/noticeboard*')) ? 'active' : '' }}">
    <div class="iocn-link">
        <a href="{{ route('student.noticeboard.list') }}">
            <div class="sidebar_icon left-icon ">
...
<li class="nav-links-li {{ (request()->is('student/events/list*')) ? 'active' : '' }}">
    <div class="iocn-link">
