...
<div class="row">
    ...
    {{ isset($school_currency['school_currency']) && $school_currency['school_currency'] == $currency['code'] ? 'selected' : '' }}>
    {{ $currency['code'] }}
</option>
                                ...
                                <div class="fpb-7">
                                    ...
                                    <select class="form-select eForm-select eChoice-multiple-with-remove"  id = "currency_position" name="currency_position" required>
                                       <option value="left" {{ isset($school_currency['currency_position']) && $school_currency['currency_position'] == 'left' ? 'selected' : '' }}>
    {{ get_phrase('left') }}
</option>

                                       <option value="right" {{ isset($school_currency['currency_position']) && $school_currency['currency_position'] == 'right' ? 'selected' : '' }}>
    {{ get_phrase('right') }}
</option>
<option value="left-space" {{ isset($school_currency['currency_position']) && $school_currency['currency_position'] == 'left-space' ? 'selected' : '' }}>
    {{ get_phrase('left with a space') }}
</option>
<option value="right-space" {{ isset($school_currency['currency_position']) && $school_currency['currency_position'] == 'right-space' ? 'selected' : '' }}>
    {{ get_phrase('right with a space') }}
</option>
                               ...
                               <input type="hidden" id="update_id" name="update_id" value="{{ isset($school_currency['id']) ? $school_currency['id'] : '' }}">
