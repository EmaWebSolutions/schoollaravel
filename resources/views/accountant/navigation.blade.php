    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            @endif
             ...
             <li class="nav-links-li {{ (request()->is('accountant/noticeboard*')) ? 'active' : '' }}">
    <div class="iocn-link">
        <a href="{{ route('accountant.noticeboard.list') }}">
            <div class="sidebar_icon left-icon ">
...
<li class="nav-links-li {{ (request()->is('accountant/events/list*')) ? 'active' : '' }}">
    <div class="iocn-link">
        <a href="{{ route('accountant.events.list') }}">
            <div class="sidebar_icon left-icon">
